...
const ChatSidebar: React.FC<ChatSidebarProps> = ({
  ...
  const sidebarClasses = `
    w-80 bg-white border-r border-secondary-200 
  ...
  return (
    <>
      ...
      <div className={`max-md:hidden ${animation}  ${!isOpen ? 'w-20 opacity-100' : 'w-0 opacity-0'} flex flex-col h-full w-20 border-r bg-white border-secondary-200`}>
        <button
          onClick={onClose}
          className=" py-3 text-secondary-600 hover:text-secondary-800 flex justify-center"
        >
